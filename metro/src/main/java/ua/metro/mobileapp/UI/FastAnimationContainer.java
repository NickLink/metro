...
public class FastAnimationContainer {
    ...
    private FastAnimationContainer(ImageView imageView) {
        init(imageView);
    };

    // single instance procedures
    private static FastAnimationContainer sInstance;

    public static FastAnimationContainer getInstance(ImageView imageView) {
        if (sInstance == null)
            sInstance = new FastAnimationContainer(imageView);
        return sInstance;
    }
