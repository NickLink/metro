...
public class Out_AuthQuestion extends Activity implements OnTaskCompleted {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.out_auth_question);
        ...
        subTitleTextView.setText(getString(R.string.login_sendquetion));
        ...
        sendButton.setOnClickListener(new OnSingleClickListener() {
            ...
            public void onSingleClick(View view) {
            	...
            	if(text_ok&email_ok&phone_ok) {
					...
					loader = new ProgressDialog(Out_AuthQuestion.this);
					loader.setMessage(getString(R.string.app_Loading));
					loader.show();
					
					HTTPAsynkTask mt = new HTTPAsynkTask(Out_AuthQuestion.this,
							GlobalConstants.FEEDBACK, 
							//null, null, 
							params, 
							Out_AuthQuestion.this);
					mt.execute();
            	} else {
	...
	public void onTaskCompleted(int id) {
		...
		case GlobalConstants.FEEDBACK:
			if(MeApp.regData.isSuccess()){
				BottomDialog.BottomMessageDialog(Out_AuthQuestion.this, messageSent, 
				...
				switch(error_code){
				case 801:
					Toast.makeText(Out_AuthQuestion.this, 
			...
			case GlobalConstants.NO_INTERNET_CONNECTION:
				BottomDialog.BottomSelectDialog(Out_AuthQuestion.this, 
	    			noInternetConn, 
			...
			case GlobalConstants.ERROR_401:
	        	...
	        	startActivity(new Intent(Out_AuthQuestion.this, Out_RegInStart.class)); 
				finish();
				break;
	    ...
	    public void handleMessage(Message msg) {
	        if (msg != null) {
	            ...
	            if (msg.what == GlobalConstants.retCodeLeft) {
	            	...
	            	Out_AuthQuestion.this.finishAffinity();
